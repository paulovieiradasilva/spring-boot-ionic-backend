...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "vieiraweb.tecnologia@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bcrypt.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "paulovieiradasilva@hotmail.com.br", "20695028480", TipoCliente.PESSOAFISICA, bcrypt.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("93883321", "34252625"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 303", "Jardim", "3822084", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 803", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "53300210", cli2, c2);

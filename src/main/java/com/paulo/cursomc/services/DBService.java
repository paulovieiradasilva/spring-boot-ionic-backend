...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "vieiraweb.tecnologia@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, bcrypt.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "paulovieiradasilva@hotmail.com.br", "20695028480",
				TipoCliente.PESSOAFISICA, bcrypt.encode("123"));
